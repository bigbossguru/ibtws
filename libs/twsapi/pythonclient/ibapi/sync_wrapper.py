...
class TWSSyncWrapper(EWrapper, EClient):
    ...
    def openOrder(self, orderId: OrderId, contract: Contract, order: Order, orderState: OrderState):
        ...
        open_order_data = {"orderId": orderId, "contract": contract, "order": order, "orderState": orderState}
    ...
    def position(self, account: str, contract: Contract, position: Decimal, avgCost: float):
        ...
        self.positions[account].append({"contract": contract, "position": position, "avgCost": avgCost})
    ...
    def tickNews(self, reqId, timeStamp, providerCode, articleId, headline, extraData):
        ...
        self.market_data[reqId]["News"].append({
            "timeStamp": timeStamp,
