...
from ibapi.errors import (
    ...
    FAIL_SEND_REQHISTDATA,
    FAIL_SEND_CANHISTDATA,
    FAIL_SEND_REQRTBARS,
    FAIL_SEND_CANRTBARS,
    ...
    FAIL_SEND_REQMARKETDATATYPE,
    FAIL_SEND_REQPOSITIONS,
    FAIL_SEND_CANPOSITIONS,
    FAIL_SEND_REQACCOUNTDATA,
    FAIL_SEND_CANACCOUNTDATA,
    FAIL_SEND_VERIFYREQUEST,
    FAIL_SEND_VERIFYMESSAGE,
    FAIL_SEND_QUERYDISPLAYGROUPS,
    FAIL_SEND_SUBSCRIBETOGROUPEVENTS,
    FAIL_SEND_UPDATEDISPLAYGROUP,
    FAIL_SEND_UNSUBSCRIBEFROMGROUPEVENTS,
    FAIL_SEND_STARTAPI,
    FAIL_SEND_VERIFYANDAUTHREQUEST,
    FAIL_SEND_VERIFYANDAUTHMESSAGE,
    FAIL_SEND_REQPOSITIONSMULTI,
    FAIL_SEND_CANPOSITIONSMULTI,
    FAIL_SEND_REQACCOUNTUPDATESMULTI,
    FAIL_SEND_CANACCOUNTUPDATESMULTI,
    FAIL_SEND_REQSECDEFOPTPARAMS,
    FAIL_SEND_REQSOFTDOLLARTIERS,
    FAIL_SEND_REQFAMILYCODES,
    FAIL_SEND_REQMATCHINGSYMBOLS,
    FAIL_SEND_REQMKTDEPTHEXCHANGES,
    FAIL_SEND_REQSMARTCOMPONENTS,
    FAIL_SEND_REQNEWSPROVIDERS,
    FAIL_SEND_REQNEWSARTICLE,
    FAIL_SEND_REQHISTORICALNEWS,
    FAIL_SEND_REQHEADTIMESTAMP,
    FAIL_SEND_REQHISTOGRAMDATA,
    FAIL_SEND_CANCELHISTOGRAMDATA,
    FAIL_SEND_CANCELHEADTIMESTAMP,
    FAIL_SEND_REQMARKETRULE,
    FAIL_SEND_REQPNL,
    FAIL_SEND_CANCELPNL,
    FAIL_SEND_REQPNLSINGLE,
    FAIL_SEND_CANCELPNLSINGLE,
    FAIL_SEND_REQHISTORICALTICKS,
    FAIL_SEND_REQTICKBYTICKDATA,
    FAIL_SEND_CANCELTICKBYTICKDATA,
    FAIL_SEND_REQCOMPLETEDORDERS,
    FAIL_SEND_REQ_WSH_META_DATA,
    FAIL_SEND_CAN_WSH_META_DATA,
    FAIL_SEND_REQ_WSH_EVENT_DATA,
    FAIL_SEND_CAN_WSH_EVENT_DATA,
    FAIL_SEND_REQ_USER_INFO,
    FAIL_SEND_REQCURRTIMEINMILLIS,
    FAIL_SEND_CANCEL_CONTRACT_DATA,
    FAIL_SEND_CANCEL_HISTORICAL_TICKS,
    FAIL_SEND_REQCONFIG,
    FAIL_SEND_UPDATECONFIG,
)
...
from ibapi.client_utils import (
    createAllOpenOrdersRequestProto,
    createAutoOpenOrdersRequestProto,
    createOpenOrdersRequestProto,
    createCompletedOrdersRequestProto,
)
...
from ibapi.client_utils import (
    ...
    createVerifyRequestProto,
    createVerifyMessageRequestProto,
    createQueryDisplayGroupsRequestProto,
)
from ibapi.client_utils import (
    createSubscribeToGroupEventsRequestProto,
    createUpdateDisplayGroupRequestProto,
    createUnsubscribeFromGroupEventsRequestProto,
...
from ibapi.protobuf.CalculateImpliedVolatilityRequest_pb2 import (
    CalculateImpliedVolatilityRequest as CalculateImpliedVolatilityRequestProto,
)
from ibapi.protobuf.CancelCalculateImpliedVolatility_pb2 import (
    CancelCalculateImpliedVolatility as CancelCalculateImpliedVolatilityProto,
)
from ibapi.protobuf.CalculateOptionPriceRequest_pb2 import (
...
from ibapi.protobuf.SubscribeToGroupEventsRequest_pb2 import (
    SubscribeToGroupEventsRequest as SubscribeToGroupEventsRequestProto,
)
from ibapi.protobuf.UpdateDisplayGroupRequest_pb2 import UpdateDisplayGroupRequest as UpdateDisplayGroupRequestProto
from ibapi.protobuf.UnsubscribeFromGroupEventsRequest_pb2 import (
    UnsubscribeFromGroupEventsRequest as UnsubscribeFromGroupEventsRequestProto,
)
from ibapi.protobuf.MarketDepthExchangesRequest_pb2 import (
    MarketDepthExchangesRequest as MarketDepthExchangesRequestProto,
)
...
class EClient(object):
    ...
    def checkConnected(self):
        if self.isConnected():
            raise ClientException(ALREADY_CONNECTED.code(), ALREADY_CONNECTED.msg(), "")
    ...
    def startApi(self):
        ...
        try:
            ...
            self.wrapper.error(
                NO_VALID_ID, currentTimeMillis(), FAIL_SEND_STARTAPI.code(), FAIL_SEND_STARTAPI.msg() + str(ex)
            )
            return
    ...
    def isConnected(self):
        ...
        logger.debug(f"{id(self)} isConn: {self.connState}, connConnected: {str(connConnected)}")
    ...
    def run(self):
        ...
        try:
            while self.isConnected() or not self.msg_queue.empty():
                ...
                logger.debug("conn:%d queue.sz:%d", self.isConnected(), self.msg_queue.qsize())
        finally:
            self.disconnect()
    ...
    def reqCurrentTime(self):
        ...
        try:
            ...
            self.wrapper.error(
                NO_VALID_ID, currentTimeMillis(), FAIL_SEND_REQCURRTIME.code(), FAIL_SEND_REQCURRTIME.msg() + str(ex)
            )
            return
    ...
    def setServerLogLevel(self, logLevel: int):
        ...
        try:
            ...
            self.wrapper.error(
                NO_VALID_ID,
                currentTimeMillis(),
                FAIL_SEND_SERVER_LOG_LEVEL.code(),
                FAIL_SEND_SERVER_LOG_LEVEL.msg() + str(ex),
            )
            return
    ...
    def reqMktData(
        ...
        if self.useProtoBuf(OUT.REQ_MKT_DATA):
            marketDataRequestProto = createMarketDataRequestProto(
    ...
    def reqMarketDataType(self, marketDataType: int):
        ...
        try:
            ...
            self.wrapper.error(
                NO_VALID_ID,
                currentTimeMillis(),
                FAIL_SEND_REQMARKETDATATYPE.code(),
                FAIL_SEND_REQMARKETDATATYPE.msg() + str(ex),
            )
            return
    ...
    def reqSmartComponents(self, reqId: int, bboExchange: str):
        ...
        try:
            ...
            self.wrapper.error(
                reqId,
                currentTimeMillis(),
                FAIL_SEND_REQSMARTCOMPONENTS.code(),
                FAIL_SEND_REQSMARTCOMPONENTS.msg() + str(ex),
            )
            return
    ...
    def reqMarketRule(self, marketRuleId: int):
        ...
        try:
            ...
            self.wrapper.error(
                NO_VALID_ID,
                currentTimeMillis(),
                FAIL_SEND_REQMARKETRULE.code(),
                FAIL_SEND_REQMARKETRULE.msg() + str(ex),
            )
            return
    ...
    def reqTickByTickData(
        ...
        if self.serverVersion() < MIN_SERVER_VER_TICK_BY_TICK_IGNORE_SIZE:
            self.wrapper.error(
                ...
                currentTimeMillis(),
                UPDATE_TWS.code(),
                UPDATE_TWS.msg() + " It does not support ignoreSize and numberOfTicks parameters "
        ...
        try:
            ...
            self.wrapper.error(
                reqId,
                currentTimeMillis(),
                FAIL_SEND_REQTICKBYTICKDATA.code(),
                FAIL_SEND_REQTICKBYTICKDATA.msg() + str(ex),
            )
            return
    ...
    def cancelTickByTickData(self, reqId: int):
        ...
        try:
            ...
            self.wrapper.error(
                reqId,
                currentTimeMillis(),
                FAIL_SEND_CANCELTICKBYTICKDATA.code(),
                FAIL_SEND_CANCELTICKBYTICKDATA.msg() + str(ex),
            )
            return
    ...
    def calculateImpliedVolatility(
        ...
        if self.useProtoBuf(OUT.REQ_CALC_IMPLIED_VOLAT):
            calculateImpliedVolatilityRequestProto = createCalculateImpliedVolatilityRequestProto(
        ...
        if self.serverVersion() < MIN_SERVER_VER_REQ_CALC_IMPLIED_VOLAT:
            self.wrapper.error(
                ...
                currentTimeMillis(),
                UPDATE_TWS.code(),
                UPDATE_TWS.msg() + "  It does not support calculateImpliedVolatility req.",
            )
            return
        ...
        try:
            ...
            self.wrapper.error(
                reqId,
                currentTimeMillis(),
                FAIL_SEND_REQCALCIMPLIEDVOLAT.code(),
                FAIL_SEND_REQCALCIMPLIEDVOLAT.msg() + str(ex),
            )
            return

    def calculateImpliedVolatilityProtoBuf(
        self, calculateImpliedVolatilityRequestProto: CalculateImpliedVolatilityRequestProto
    ):
        ...
        reqId = (
            calculateImpliedVolatilityRequestProto.reqId
            if calculateImpliedVolatilityRequestProto.HasField("reqId")
            else NO_VALID_ID
        )
    ...
    def cancelCalculateImpliedVolatility(self, reqId: TickerId):
        ...
        try:
            ...
            self.wrapper.error(
                reqId,
                currentTimeMillis(),
                FAIL_SEND_CANCALCIMPLIEDVOLAT.code(),
                FAIL_SEND_CANCALCIMPLIEDVOLAT.msg() + str(ex),
            )
            return

    def cancelCalculateImpliedVolatilityProtoBuf(
        self, cancelCalculateImpliedVolatilityProto: CancelCalculateImpliedVolatilityProto
    ):
        ...
        reqId = (
            cancelCalculateImpliedVolatilityProto.reqId
            if cancelCalculateImpliedVolatilityProto.HasField("reqId")
            else NO_VALID_ID
        )
    ...
    def calculateOptionPrice(
        ...
        if self.useProtoBuf(OUT.REQ_CALC_OPTION_PRICE):
            calculateOptionPriceRequestProto = createCalculateOptionPriceRequestProto(
        ...
        try:
            ...
            self.wrapper.error(
                reqId,
                currentTimeMillis(),
                FAIL_SEND_REQCALCOPTIONPRICE.code(),
                FAIL_SEND_REQCALCOPTIONPRICE.msg() + str(ex),
            )
            return
    ...
    def calculateOptionPriceProtoBuf(self, calculateOptionPriceRequestProto: CalculateOptionPriceRequestProto):
        ...
        reqId = (
            calculateOptionPriceRequestProto.reqId
            if calculateOptionPriceRequestProto.HasField("reqId")
            else NO_VALID_ID
        )
    ...
    def cancelCalculateOptionPrice(self, reqId: TickerId):
        ...
        try:
            ...
            self.wrapper.error(
                reqId,
                currentTimeMillis(),
                FAIL_SEND_CANCALCOPTIONPRICE.code(),
                FAIL_SEND_CANCALCOPTIONPRICE.msg() + str(ex),
            )
            return
    ...
    def cancelCalculateOptionPriceProtoBuf(self, cancelCalculateOptionPriceProto: CancelCalculateOptionPriceProto):
        ...
        reqId = (
            cancelCalculateOptionPriceProto.reqId if cancelCalculateOptionPriceProto.HasField("reqId") else NO_VALID_ID
        )
    ...
    def exerciseOptions(
        ...
        if self.useProtoBuf(OUT.EXERCISE_OPTIONS):
            exerciseOptionsRequestProto = createExerciseOptionsRequestProto(
                reqId,
                contract,
                exerciseAction,
                exerciseQuantity,
        ...
        if self.serverVersion() < MIN_SERVER_VER_TRADING_CLASS:
            if contract.tradingClass or contract.conId > 0:
                self.wrapper.error(
                    ...
                    currentTimeMillis(),
                    UPDATE_TWS.code(),
                    UPDATE_TWS.msg() + "  It does not support conId and tradingClass parameters in exerciseOptions.",
                )
                return
        ...
        if self.serverVersion() < MIN_SERVER_VER_MANUAL_ORDER_TIME_EXERCISE_OPTIONS and manualOrderTime:
            self.wrapper.error(
                ...
                currentTimeMillis(),
                UPDATE_TWS.code(),
                UPDATE_TWS.msg() + "  It does not support manual order time parameter in exerciseOptions.",
            )
            return
        ...
        if self.serverVersion() < MIN_SERVER_VER_PROFESSIONAL_CUSTOMER and professionalCustomer:
            self.wrapper.error(
                reqId,
                currentTimeMillis(),
                UPDATE_TWS.code(),
    ...
    def exerciseOptionsProtoBuf(self, exerciseOptionsRequestProto: ExerciseOptionsRequestProto):
        ...
        orderId = (
            exerciseOptionsRequestProto.orderId if exerciseOptionsRequestProto.HasField("orderId") else NO_VALID_ID
        )
    ...
    def placeOrder(self, orderId: OrderId, contract: Contract, order: Order):
        ...
        if self.serverVersion() < MIN_SERVER_VER_AUTO_PRICE_FOR_HEDGE and order.dontUseAutoPriceForHedge:
            self.wrapper.error(
                ...
                currentTimeMillis(),
                UPDATE_TWS.code(),
                UPDATE_TWS.msg() + " It does not support dontUseAutoPriceForHedge parameter",
            )
            return
        ...
        if self.serverVersion() < MIN_SERVER_VER_CUSTOMER_ACCOUNT and order.customerAccount:
            self.wrapper.error(
                orderId,
                currentTimeMillis(),
                UPDATE_TWS.code(),
        ...
        if self.serverVersion() < MIN_SERVER_VER_PROFESSIONAL_CUSTOMER and order.professionalCustomer:
            self.wrapper.error(
                orderId,
                currentTimeMillis(),
                UPDATE_TWS.code(),
        ...
        if self.serverVersion() < MIN_SERVER_VER_INCLUDE_OVERNIGHT and order.includeOvernight:
            self.wrapper.error(
                orderId,
                currentTimeMillis(),
                UPDATE_TWS.code(),
        ...
        if self.serverVersion() < MIN_SERVER_VER_CME_TAGGING_FIELDS and order.manualOrderIndicator != UNSET_INTEGER:
            self.wrapper.error(
                NO_VALID_ID,
                currentTimeMillis(),
                UPDATE_TWS.code(),
        ...
        try:
            ...
            if self.serverVersion() < MIN_SERVER_VER_ORDER_COMBO_LEGS_PRICE:
                flds.append(make_field(order.lmtPrice if order.lmtPrice != UNSET_DOUBLE else 0))
            else:
                flds.append(make_field_handle_empty(order.lmtPrice))
            if self.serverVersion() < MIN_SERVER_VER_TRAILING_PERCENT:
                flds.append(make_field(order.auxPrice if order.auxPrice != UNSET_DOUBLE else 0))
            else:
            ...
            if self.serverVersion() >= MIN_SERVER_VER_SMART_COMBO_ROUTING_PARAMS and contract.secType == "BAG":
                smartComboRoutingParamsCount = (
                    len(order.smartComboRoutingParams) if order.smartComboRoutingParams else 0
                )
            ...
            if self.serverVersion() >= MIN_SERVER_VER_PRICE_MGMT_ALGO:
                flds.append(
                    make_field_handle_empty(
                        UNSET_INTEGER if order.usePriceMgmtAlgo is None else 1 if order.usePriceMgmtAlgo else 0
                    )
                )
        ...
        if placeOrderRequestProto.HasField("order"):
            ...
            if wrongParam is not None:
                self.wrapper.error(
                    ...
                    UPDATE_TWS.code(),
                    UPDATE_TWS.msg()
                    + " The following order parameter is not supported by your TWS version - "
                    + wrongParam,
                )
                return
        ...
        if placeOrderRequestProto.HasField("attachedOrders"):
            ...
            if wrongParam is not None:
                self.wrapper.error(
                    ...
                    UPDATE_TWS.code(),
                    UPDATE_TWS.msg()
                    + " The following attached orders parameter is not supported by your TWS version - "
                    + wrongParam,
                )
                return
    ...
    def cancelOrder(self, orderId: OrderId, orderCancel: OrderCancel):
        ...
        if self.serverVersion() < MIN_SERVER_VER_MANUAL_ORDER_TIME and orderCancel.manualOrderCancelTime:
            self.wrapper.error(
                orderId,
                currentTimeMillis(),
                UPDATE_TWS.code(),
    ...
    def reqOpenOrders(self):
        ...
        try:
            ...
            self.wrapper.error(
                NO_VALID_ID, currentTimeMillis(), FAIL_SEND_OORDER.code(), FAIL_SEND_OORDER.msg() + str(ex)
            )
            return
    ...
    def reqGlobalCancel(self, orderCancel: OrderCancel):
        ...
        try:
            ...
            self.wrapper.error(
                NO_VALID_ID,
                currentTimeMillis(),
                FAIL_SEND_REQGLOBALCANCEL.code(),
                FAIL_SEND_REQGLOBALCANCEL.msg() + str(ex),
            )
            return
    ...
    def reqIds(self, numIds: int):
        ...
        try:
            ...
            self.wrapper.error(
                NO_VALID_ID, currentTimeMillis(), FAIL_SEND_CORDER.code(), FAIL_SEND_CORDER.msg() + str(ex)
            )
            return
    ...
    def reqAccountSummary(self, reqId: int, groupName: str, tags: str):
        ...
        try:
            ...
            msg = make_field(VERSION) + make_field(reqId) + make_field(groupName) + make_field(tags)
            ...
            self.wrapper.error(
                reqId, currentTimeMillis(), FAIL_SEND_REQACCOUNTDATA.code(), FAIL_SEND_REQACCOUNTDATA.msg() + str(ex)
            )
            return
    ...
    def cancelAccountSummary(self, reqId: int):
        ...
        try:
            ...
            self.wrapper.error(
                reqId, currentTimeMillis(), FAIL_SEND_CANACCOUNTDATA.code(), FAIL_SEND_CANACCOUNTDATA.msg() + str(ex)
            )
            return
    ...
    def reqPositions(self):
        ...
        try:
            ...
            self.wrapper.error(
                NO_VALID_ID, currentTimeMillis(), FAIL_SEND_REQPOSITIONS.code(), FAIL_SEND_REQPOSITIONS.msg() + str(ex)
            )
            return
    ...
    def cancelPositions(self):
        ...
        try:
            ...
            self.wrapper.error(
                NO_VALID_ID, currentTimeMillis(), FAIL_SEND_CANPOSITIONS.code(), FAIL_SEND_CANPOSITIONS.msg() + str(ex)
            )
            return
    ...
    def reqPositionsMulti(self, reqId: int, account: str, modelCode: str):
        ...
        try:
            ...
            msg = make_field(VERSION) + make_field(reqId) + make_field(account) + make_field(modelCode)
            ...
            self.wrapper.error(
                reqId,
                currentTimeMillis(),
                FAIL_SEND_REQPOSITIONSMULTI.code(),
                FAIL_SEND_REQPOSITIONSMULTI.msg() + str(ex),
            )
            return
    ...
    def cancelPositionsMulti(self, reqId: int):
        ...
        try:
            ...
            self.wrapper.error(
                reqId,
                currentTimeMillis(),
                FAIL_SEND_CANPOSITIONSMULTI.code(),
                FAIL_SEND_CANPOSITIONSMULTI.msg() + str(ex),
            )
            return
    ...
    def reqAccountUpdatesMulti(self, reqId: int, account: str, modelCode: str, ledgerAndNLV: bool):
        ...
        if self.useProtoBuf(OUT.REQ_ACCOUNT_UPDATES_MULTI):
            self.reqAccountUpdatesMultiProtoBuf(
                createAccountUpdatesMultiRequestProto(reqId, account, modelCode, ledgerAndNLV)
            )
            return
        ...
        try:
            ...
            self.wrapper.error(
                reqId,
                currentTimeMillis(),
                FAIL_SEND_REQACCOUNTUPDATESMULTI.code(),
                FAIL_SEND_REQACCOUNTUPDATESMULTI.msg() + str(ex),
            )
            return
    ...
    def reqAccountUpdatesMultiProtoBuf(self, accountUpdatesMultiRequestProto: AccountUpdatesMultiRequestProto):
        ...
        reqId = (
            accountUpdatesMultiRequestProto.reqId if accountUpdatesMultiRequestProto.HasField("reqId") else NO_VALID_ID
        )
    ...
    def cancelAccountUpdatesMulti(self, reqId: int):
        ...
        try:
            ...
            self.wrapper.error(
                reqId,
                currentTimeMillis(),
                FAIL_SEND_CANACCOUNTUPDATESMULTI.code(),
                FAIL_SEND_CANACCOUNTUPDATESMULTI.msg() + str(ex),
            )
            return
    ...
    def cancelAccountUpdatesMultiProtoBuf(self, cancelAccountUpdatesMultiProto: CancelAccountUpdatesMultiProto):
        ...
        reqId = (
            cancelAccountUpdatesMultiProto.reqId if cancelAccountUpdatesMultiProto.HasField("reqId") else NO_VALID_ID
        )
    ...
    def cancelPnL(self, reqId: int):
        ...
        try:
            ...
            self.wrapper.error(
                reqId, currentTimeMillis(), FAIL_SEND_CANCELPNL.code(), FAIL_SEND_CANCELPNL.msg() + str(ex)
            )
            return
    ...
    def reqPnLSingle(self, reqId: int, account: str, modelCode: str, conid: int):
        ...
        try:
            msg = make_field(reqId) + make_field(account) + make_field(modelCode) + make_field(conid)
            ...
            self.wrapper.error(
                reqId, currentTimeMillis(), FAIL_SEND_REQPNLSINGLE.code(), FAIL_SEND_REQPNLSINGLE.msg() + str(ex)
            )
            return
    ...
    def cancelPnLSingle(self, reqId: int):
        ...
        try:
            ...
            self.wrapper.error(
                reqId, currentTimeMillis(), FAIL_SEND_CANCELPNLSINGLE.code(), FAIL_SEND_CANCELPNLSINGLE.msg() + str(ex)
            )
            return
    ...
    def reqExecutions(self, reqId: int, execFilter: ExecutionFilter):
        ...
        if self.serverVersion() < MIN_SERVER_VER_PARAMETRIZED_DAYS_OF_EXECUTIONS:
            if execFilter.lastNDays != UNSET_INTEGER or execFilter.specificDates is not None:
                self.wrapper.error(
                    reqId,
                    currentTimeMillis(),
                    UPDATE_TWS.code(),
                    UPDATE_TWS.msg() + "  It does not support last N days and specific dates parameters",
                )
                return
    ...
    def reqContractDetails(self, reqId: int, contract: Contract):
        ...
        if self.serverVersion() < MIN_SERVER_VER_BOND_ISSUERID:
            if contract.issuerId:
                self.wrapper.error(
                    ...
                    currentTimeMillis(),
                    UPDATE_TWS.code(),
                    UPDATE_TWS.msg() + "  It does not support issuerId parameter in reqContractDetails.",
                )
                return
        ...
        try:
            ...
            if self.serverVersion() >= MIN_SERVER_VER_PRIMARYEXCH:
                ...
                if contract.primaryExchange and (contract.exchange == "BEST" or contract.exchange == "SMART"):
                    flds += [
            ...
            self.wrapper.error(
                reqId, currentTimeMillis(), FAIL_SEND_REQCONTRACT.code(), FAIL_SEND_REQCONTRACT.msg() + str(ex)
            )
            return
    ...
    def reqMktDepthExchanges(self):
        ...
        if self.serverVersion() < MIN_SERVER_VER_REQ_MKT_DEPTH_EXCHANGES:
            self.wrapper.error(
                ...
                currentTimeMillis(),
                UPDATE_TWS.code(),
                UPDATE_TWS.msg() + "  It does not support market depth exchanges request.",
            )
            return
        ...
        try:
            ...
            self.wrapper.error(
                NO_VALID_ID,
                currentTimeMillis(),
                FAIL_SEND_REQMKTDEPTHEXCHANGES.code(),
                FAIL_SEND_REQMKTDEPTHEXCHANGES.msg() + str(ex),
            )
            return
    ...
    def reqMktDepth(
        ...
        if self.useProtoBuf(OUT.REQ_MKT_DEPTH):
            marketDepthRequestProto = createMarketDepthRequestProto(
        ...
        try:
            ...
            self.wrapper.error(
                reqId, currentTimeMillis(), FAIL_SEND_REQMKTDEPTH.code(), FAIL_SEND_REQMKTDEPTH.msg() + str(ex)
            )
            return
    ...
    def cancelMktDepth(self, reqId: TickerId, isSmartDepth: bool):
        ...
        try:
            ...
            self.wrapper.error(
                reqId, currentTimeMillis(), FAIL_SEND_CANMKTDEPTH.code(), FAIL_SEND_CANMKTDEPTH.msg() + str(ex)
            )
            return
    ...
    def requestFA(self, faData: FaDataType):
        ...
        try:
            ...
            self.wrapper.error(
                NO_VALID_ID, currentTimeMillis(), FAIL_SEND_FA_REQUEST.code(), FAIL_SEND_FA_REQUEST.msg() + str(ex)
            )
            return
    ...
    def replaceFA(self, reqId: TickerId, faData: FaDataType, cxml: str):
        ...
        if self.serverVersion() >= MIN_SERVER_VER_FA_PROFILE_DESUPPORT and faData == 2:
            self.wrapper.error(
                reqId, currentTimeMillis(), FA_PROFILE_NOT_SUPPORTED.code(), FA_PROFILE_NOT_SUPPORTED.msg()
            )
            return
        ...
        try:
            ...
            self.wrapper.error(
                NO_VALID_ID, currentTimeMillis(), FAIL_SEND_FA_REPLACE.code(), FAIL_SEND_FA_REPLACE.msg() + str(ex)
            )
            return
    ...
    def replaceFAProtoBuf(self, faReplaceProto: FAReplaceProto):
        ...
        try:
            ...
            self.wrapper.error(
                reqId, currentTimeMillis(), FAIL_SEND_FA_REPLACE.code(), FAIL_SEND_FA_REPLACE.msg() + str(ex)
            )
            return
    ...
    def reqHistoricalData(
        ...
        try:
            ...
            self.wrapper.error(
                NO_VALID_ID, currentTimeMillis(), FAIL_SEND_REQHISTDATA.code(), FAIL_SEND_REQHISTDATA.msg() + str(ex)
            )
            return
    ...
    def reqHistoricalDataProtoBuf(self, historicalDataRequestProto: HistoricalDataRequestProto):
        ...
        try:
            ...
            self.wrapper.error(
                reqId, currentTimeMillis(), FAIL_SEND_REQHISTDATA.code(), FAIL_SEND_REQHISTDATA.msg() + str(ex)
            )
            return
    ...
    def cancelHistoricalData(self, reqId: TickerId):
        ...
        try:
            ...
            self.wrapper.error(
                reqId, currentTimeMillis(), FAIL_SEND_CANHISTDATA.code(), FAIL_SEND_CANHISTDATA.msg() + str(ex)
            )
            return
    ...
    def reqHeadTimeStamp(
        ...
        try:
            ...
            self.wrapper.error(
                reqId,
                currentTimeMillis(),
                FAIL_SEND_REQHEADTIMESTAMP.code(),
                FAIL_SEND_REQHEADTIMESTAMP.msg() + str(ex),
            )
            return
    ...
    def cancelHeadTimeStamp(self, reqId: TickerId):
        ...
        try:
            ...
            self.wrapper.error(
                NO_VALID_ID,
                currentTimeMillis(),
                FAIL_SEND_CANCELHEADTIMESTAMP.code(),
                FAIL_SEND_CANCELHEADTIMESTAMP.msg() + str(ex),
            )
            return
    ...
    def reqHistogramData(self, tickerId: int, contract: Contract, useRTH: bool, timePeriod: str):
        ...
        try:
            ...
            self.wrapper.error(
                tickerId,
                currentTimeMillis(),
                FAIL_SEND_REQHISTOGRAMDATA.code(),
                FAIL_SEND_REQHISTOGRAMDATA.msg() + str(ex),
            )
            return
    ...
    def cancelHistogramData(self, tickerId: int):
        ...
        try:
            ...
            self.wrapper.error(
                tickerId,
                currentTimeMillis(),
                FAIL_SEND_CANCELHISTOGRAMDATA.code(),
                FAIL_SEND_CANCELHISTOGRAMDATA.msg() + str(ex),
            )
            return
    ...
    def reqHistoricalTicks(
        ...
        try:
            ...
            self.wrapper.error(
                reqId,
                currentTimeMillis(),
                FAIL_SEND_REQHISTORICALTICKS.code(),
                FAIL_SEND_REQHISTORICALTICKS.msg() + str(ex),
            )
            return
    ...
    def reqScannerParameters(self):
        ...
        try:
            ...
            self.wrapper.error(
                NO_VALID_ID,
                currentTimeMillis(),
                FAIL_SEND_REQSCANNERPARAMETERS.code(),
                FAIL_SEND_REQSCANNERPARAMETERS.msg() + str(ex),
            )
            return
    ...
    def reqScannerSubscription(
        ...
        if self.useProtoBuf(OUT.REQ_SCANNER_SUBSCRIPTION):
            self.reqScannerSubscriptionProtoBuf(
                createScannerSubscriptionRequestProto(
        ...
        if self.serverVersion() < MIN_SERVER_VER_SCANNER_GENERIC_OPTS and scannerSubscriptionFilterOptions is not None:
            self.wrapper.error(
                ...
                currentTimeMillis(),
                UPDATE_TWS.code(),
                UPDATE_TWS.msg() + " It does not support API scanner subscription generic filter options",
            )
            return
        ...
        try:
            ...
            self.wrapper.error(
                reqId, currentTimeMillis(), FAIL_SEND_REQSCANNER.code(), FAIL_SEND_REQSCANNER.msg() + str(ex)
            )
            return
    ...
    def reqScannerSubscriptionProtoBuf(self, scannerSubscriptionRequestProto: ScannerSubscriptionRequestProto):
        ...
        reqId = (
            scannerSubscriptionRequestProto.reqId if scannerSubscriptionRequestProto.HasField("reqId") else NO_VALID_ID
        )
    ...
    def cancelScannerSubscription(self, reqId: int):
        ...
        try:
            ...
            self.wrapper.error(
                reqId, currentTimeMillis(), FAIL_SEND_CANSCANNER.code(), FAIL_SEND_CANSCANNER.msg() + str(ex)
            )
            return
    ...
    def cancelScannerSubscriptionProtoBuf(self, cancelScannerSubscriptionProto: CancelScannerSubscriptionProto):
        ...
        reqId = (
            cancelScannerSubscriptionProto.reqId if cancelScannerSubscriptionProto.HasField("reqId") else NO_VALID_ID
        )
    ...
    def reqRealTimeBars(
        ...
        try:
            ...
            self.wrapper.error(
                reqId, currentTimeMillis(), FAIL_SEND_REQRTBARS.code(), FAIL_SEND_REQRTBARS.msg() + str(ex)
            )
            return
    ...
    def cancelRealTimeBars(self, reqId: TickerId):
        ...
        try:
            ...
            self.wrapper.error(
                reqId, currentTimeMillis(), FAIL_SEND_CANRTBARS.code(), FAIL_SEND_CANRTBARS.msg() + str(ex)
            )
            return
    ...
    def reqFundamentalData(
        ...
        if self.useProtoBuf(OUT.REQ_FUNDAMENTAL_DATA):
            self.reqFundamentalsDataProtoBuf(
                createFundamentalsDataRequestProto(reqId, contract, reportType, fundamentalDataOptions)
            )
            return
        ...
        try:
            ...
            self.wrapper.error(
                reqId, currentTimeMillis(), FAIL_SEND_REQFUNDDATA.code(), FAIL_SEND_REQFUNDDATA.msg() + str(ex)
            )
            return
    ...
    def cancelFundamentalData(self, reqId: TickerId):
        ...
        try:
            ...
            self.wrapper.error(
                reqId, currentTimeMillis(), FAIL_SEND_CANFUNDDATA.code(), FAIL_SEND_CANFUNDDATA.msg() + str(ex)
            )
            return
    ...
    def reqNewsProviders(self):
        ...
        try:
            ...
            self.wrapper.error(
                NO_VALID_ID,
                currentTimeMillis(),
                FAIL_SEND_REQNEWSPROVIDERS.code(),
                FAIL_SEND_REQNEWSPROVIDERS.msg() + str(ex),
            )
            return
    ...
    def reqNewsArticle(
        ...
        if self.useProtoBuf(OUT.REQ_NEWS_ARTICLE):
            self.reqNewsArticleProtoBuf(
                createNewsArticleRequestProto(reqId, providerCode, articleId, newsArticleOptions)
            )
            return
        ...
        try:
            ...
            self.wrapper.error(
                NO_VALID_ID,
                currentTimeMillis(),
                FAIL_SEND_REQNEWSARTICLE.code(),
                FAIL_SEND_REQNEWSARTICLE.msg() + str(ex),
            )
            return
    ...
    def reqNewsArticleProtoBuf(self, newsArticleRequestProto: NewsArticleRequestProto):
        ...
        try:
            ...
            self.wrapper.error(
                reqId, currentTimeMillis(), FAIL_SEND_REQNEWSARTICLE.code(), FAIL_SEND_REQNEWSARTICLE.msg() + str(ex)
            )
            return
    ...
    def reqHistoricalNews(
        ...
        if self.useProtoBuf(OUT.REQ_HISTORICAL_NEWS):
            self.reqHistoricalNewsProtoBuf(
                createHistoricalNewsRequestProto(
        ...
        try:
            ...
            self.wrapper.error(
                NO_VALID_ID,
                currentTimeMillis(),
                FAIL_SEND_REQHISTORICALNEWS.code(),
                FAIL_SEND_REQHISTORICALNEWS.msg() + str(ex),
            )
            return
    ...
    def queryDisplayGroups(self, reqId: int):
        ...
        try:
            ...
            self.wrapper.error(
                NO_VALID_ID,
                currentTimeMillis(),
                FAIL_SEND_QUERYDISPLAYGROUPS.code(),
                FAIL_SEND_QUERYDISPLAYGROUPS.msg() + str(ex),
            )
            return
    ...
    def queryDisplayGroupsProtoBuf(self, queryDisplayGroupsRequestProto: QueryDisplayGroupsRequestProto):
        ...
        reqId = (
            queryDisplayGroupsRequestProto.reqId if queryDisplayGroupsRequestProto.HasField("reqId") else NO_VALID_ID
        )
    ...
    def subscribeToGroupEvents(self, reqId: int, groupId: int):
        ...
        try:
            ...
            self.wrapper.error(
                reqId,
                currentTimeMillis(),
                FAIL_SEND_SUBSCRIBETOGROUPEVENTS.code(),
                FAIL_SEND_SUBSCRIBETOGROUPEVENTS.msg() + str(ex),
            )
            return
    ...
    def subscribeToGroupEventsProtoBuf(self, subscribeToGroupEventsRequestProto: SubscribeToGroupEventsRequestProto):
        ...
        reqId = (
            subscribeToGroupEventsRequestProto.reqId
            if subscribeToGroupEventsRequestProto.HasField("reqId")
            else NO_VALID_ID
        )
    ...
    def updateDisplayGroup(self, reqId: int, contractInfo: str):
        ...
        try:
            ...
            self.wrapper.error(
                reqId,
                currentTimeMillis(),
                FAIL_SEND_UPDATEDISPLAYGROUP.code(),
                FAIL_SEND_UPDATEDISPLAYGROUP.msg() + str(ex),
            )
            return
    ...
    def updateDisplayGroupProtoBuf(self, updateDisplayGroupRequestProto: UpdateDisplayGroupRequestProto):
        ...
        reqId = (
            updateDisplayGroupRequestProto.reqId if updateDisplayGroupRequestProto.HasField("reqId") else NO_VALID_ID
        )
    ...
    def unsubscribeFromGroupEvents(self, reqId: int):
        ...
        try:
            ...
            self.wrapper.error(
                reqId,
                currentTimeMillis(),
                FAIL_SEND_UNSUBSCRIBEFROMGROUPEVENTS.code(),
                FAIL_SEND_UNSUBSCRIBEFROMGROUPEVENTS.msg() + str(ex),
            )
            return

    def unsubscribeFromGroupEventsProtoBuf(
        self, unsubscribeFromGroupEventsRequestProto: UnsubscribeFromGroupEventsRequestProto
    ):
        ...
        reqId = (
            unsubscribeFromGroupEventsRequestProto.reqId
            if unsubscribeFromGroupEventsRequestProto.HasField("reqId")
            else NO_VALID_ID
        )
    ...
    def verifyRequest(self, apiName: str, apiVersion: str):
        ...
        try:
            ...
            self.wrapper.error(
                NO_VALID_ID,
                currentTimeMillis(),
                FAIL_SEND_VERIFYREQUEST.code(),
                FAIL_SEND_VERIFYREQUEST.msg() + str(ex),
            )
            return
    ...
    def verifyMessage(self, apiData: str):
        ...
        try:
            ...
            self.wrapper.error(
                ...
                currentTimeMillis(),
                FAIL_SEND_VERIFYMESSAGE.code(),
                FAIL_SEND_VERIFYMESSAGE.msg() + str(ex),
            )
            return
    ...
    def verifyAndAuthRequest(self, apiName: str, apiVersion: str, opaqueIsvKey: str):
        ...
        try:
            ...
            msg = make_field(VERSION) + make_field(apiName) + make_field(apiVersion) + make_field(opaqueIsvKey)
            ...
            self.wrapper.error(
                ...
                currentTimeMillis(),
                FAIL_SEND_VERIFYANDAUTHREQUEST.code(),
                FAIL_SEND_VERIFYANDAUTHREQUEST.msg() + str(ex),
            )
            return
    ...
    def verifyAndAuthMessage(self, apiData: str, xyzResponse: str):
        ...
        try:
            ...
            self.wrapper.error(
                NO_VALID_ID,
                currentTimeMillis(),
                FAIL_SEND_VERIFYANDAUTHMESSAGE.code(),
                FAIL_SEND_VERIFYANDAUTHMESSAGE.msg() + str(ex),
            )
            return
    ...
    def reqSecDefOptParams(
        ...
        if self.useProtoBuf(OUT.REQ_SEC_DEF_OPT_PARAMS):
            self.reqSecDefOptParamsProtoBuf(
                createSecDefOptParamsRequestProto(
        ...
        if self.serverVersion() < MIN_SERVER_VER_SEC_DEF_OPT_PARAMS_REQ:
            self.wrapper.error(
                ...
                currentTimeMillis(),
                UPDATE_TWS.code(),
                UPDATE_TWS.msg() + "  It does not support security definition option request.",
            )
            return
        ...
        try:
            ...
            self.wrapper.error(
                reqId,
                currentTimeMillis(),
                FAIL_SEND_REQSECDEFOPTPARAMS.code(),
                FAIL_SEND_REQSECDEFOPTPARAMS.msg() + str(ex),
            )
            return
    ...
    def reqSoftDollarTiers(self, reqId: int):
        ...
        try:
            ...
            self.wrapper.error(
                reqId,
                currentTimeMillis(),
                FAIL_SEND_REQSOFTDOLLARTIERS.code(),
                FAIL_SEND_REQSOFTDOLLARTIERS.msg() + str(ex),
            )
            return
    ...
    def reqFamilyCodes(self):
        ...
        try:
            ...
            self.wrapper.error(
                NO_VALID_ID,
                currentTimeMillis(),
                FAIL_SEND_REQFAMILYCODES.code(),
                FAIL_SEND_REQFAMILYCODES.msg() + str(ex),
            )
            return
    ...
    def reqMatchingSymbols(self, reqId: int, pattern: str):
        ...
        try:
            ...
            self.wrapper.error(
                reqId,
                currentTimeMillis(),
                FAIL_SEND_REQMATCHINGSYMBOLS.code(),
                FAIL_SEND_REQMATCHINGSYMBOLS.msg() + str(ex),
            )
            return
    ...
    def reqCompletedOrders(self, apiOnly: bool):
        ...
        try:
            ...
            self.wrapper.error(
                NO_VALID_ID,
                currentTimeMillis(),
                FAIL_SEND_REQCOMPLETEDORDERS.code(),
                FAIL_SEND_REQCOMPLETEDORDERS.msg() + str(ex),
            )
            return
    ...
    def reqWshMetaData(self, reqId: int):
        ...
        try:
            ...
            self.wrapper.error(
                reqId,
                currentTimeMillis(),
                FAIL_SEND_REQ_WSH_META_DATA.code(),
                FAIL_SEND_REQ_WSH_META_DATA.msg() + str(ex),
            )
            return
    ...
    def cancelWshMetaData(self, reqId: int):
        ...
        try:
            ...
            self.wrapper.error(
                reqId,
                currentTimeMillis(),
                FAIL_SEND_CAN_WSH_META_DATA.code(),
                FAIL_SEND_CAN_WSH_META_DATA.msg() + str(ex),
            )
            return
    ...
    def reqWshEventData(self, reqId: int, wshEventData: WshEventData):
        ...
        try:
            ...
            self.wrapper.error(
                reqId,
                currentTimeMillis(),
                FAIL_SEND_REQ_WSH_EVENT_DATA.code(),
                FAIL_SEND_REQ_WSH_EVENT_DATA.msg() + str(ex),
            )
            return
    ...
    def cancelWshEventData(self, reqId: int):
        ...
        try:
            ...
            self.wrapper.error(
                reqId,
                currentTimeMillis(),
                FAIL_SEND_CAN_WSH_EVENT_DATA.code(),
                FAIL_SEND_CAN_WSH_EVENT_DATA.msg() + str(ex),
            )
            return
    ...
    def reqUserInfo(self, reqId: int):
        ...
        try:
            ...
            self.wrapper.error(
                reqId, currentTimeMillis(), FAIL_SEND_REQ_USER_INFO.code(), FAIL_SEND_REQ_USER_INFO.msg() + str(ex)
            )
            return
    ...
    def reqCurrentTimeInMillis(self):
        ...
        try:
            ...
            self.wrapper.error(
                NO_VALID_ID,
                currentTimeMillis(),
                FAIL_SEND_REQCURRTIMEINMILLIS.code(),
                FAIL_SEND_REQCURRTIMEINMILLIS.msg() + str(ex),
            )
            return
    ...
    def cancelContractDataProtoBuf(self, cancelContractDataProto):
        ...
        if self.serverVersion() < MIN_SERVER_VER_CANCEL_CONTRACT_DATA:
            self.wrapper.error(
                ...
                currentTimeMillis(),
                UPDATE_TWS.code(),
                UPDATE_TWS.msg() + "  It does not support contract data cancels.",
            )
            return
        ...
        try:
            ...
            self.wrapper.error(
                reqId,
                currentTimeMillis(),
                FAIL_SEND_CANCEL_CONTRACT_DATA.code(),
                FAIL_SEND_CANCEL_CONTRACT_DATA.msg() + str(ex),
            )
            return
    ...
    def cancelHistoricalTicksProtoBuf(self, cancelHistoricalTicksProto):
        ...
        if self.serverVersion() < MIN_SERVER_VER_CANCEL_CONTRACT_DATA:
            self.wrapper.error(
                ...
                currentTimeMillis(),
                UPDATE_TWS.code(),
                UPDATE_TWS.msg() + "  It does not support historical ticks cancels.",
            )
            return
        ...
        try:
            ...
            self.wrapper.error(
                reqId,
                currentTimeMillis(),
                FAIL_SEND_CANCEL_HISTORICAL_TICKS.code(),
                FAIL_SEND_CANCEL_HISTORICAL_TICKS.msg() + str(ex),
            )
            return
    ...
    def reqConfigProtoBuf(self, configRequestProto: ConfigRequestProto):
        ...
        if self.serverVersion() < MIN_SERVER_VER_CONFIG:
            self.wrapper.error(
                ...
                currentTimeMillis(),
                UPDATE_TWS.code(),
                UPDATE_TWS.msg() + "  It does not support config requests.",
            )
            return
        ...
        try:
            ...
            self.wrapper.error(
                reqId, currentTimeMillis(), FAIL_SEND_REQCONFIG.code(), FAIL_SEND_REQCONFIG.msg() + str(ex)
            )
            return
    ...
    def updateConfigProtoBuf(self, updateConfigRequestProto: UpdateConfigRequestProto):
        ...
        if self.serverVersion() < MIN_SERVER_VER_UPDATE_CONFIG:
            self.wrapper.error(
                ...
                currentTimeMillis(),
                UPDATE_TWS.code(),
                UPDATE_TWS.msg() + "  It does not support update config requests.",
            )
            return
        ...
        try:
            ...
            self.wrapper.error(
                reqId, currentTimeMillis(), FAIL_SEND_UPDATECONFIG.code(), FAIL_SEND_UPDATECONFIG.msg() + str(ex)
            )
            return
